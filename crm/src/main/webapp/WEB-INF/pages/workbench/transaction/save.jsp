	...
	<script type="text/javascript">
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				const stageValue = $("#create-stage option:selected").text();
				//表单验证
				if(stageValue==""){
					//清空可能性输入框
			...
			$("#saveCreateTranBtn").click(function () {
				...
				const money = $.trim($("#create-money").val());
				const name = $.trim($("#create-name").val());
				const expectedDate = $("#create-expectedDate").val();
				const customerName = $.trim($("#create-customerName").val());
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="hidden" id="create-activityId" value="2750dba1973a465fa31dcaf05f22dd55">
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="hidden" id="create-contactsId" value="99f1f4dc81aa44bd976edd596caa492b">
			<input type="text" class="form-control" id="create-contactsName" value="荣姐">
		</div>
	</div>
